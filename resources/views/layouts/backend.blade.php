		  ...
		  <div class="ui vertical menu">
		    ...
		    <div class="item text-center">
			  ...
			  <div class="ui center aligned">
				<a href="{{url('dashboard/avatar')}}" data-position="bottom center" data-tooltip="Change your avatar" data-inverted=""><img class="avatar-sm" src="{{(!empty(Auth::user()->avatar))? url('/storage/images/avatars/'.Auth::user()->avatar) : url("images/avatars/avatar_default.png")}}"></a>
			  </div>
