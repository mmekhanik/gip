...
<script src="{{url('js/tinymce/tinymce.js')}}"></script>
  <script type="text/javascript">
     ...
     function BrowseServer(prefix)
     {
          urlobj = prefix;
          OpenServerBrowser(
          pathAbsolute + 'filemanager?type=image',
          screen.width * 0.7,
          screen.height * 0.7 ) ;
     }
     ...
     function OpenServerBrowser( url, width, height )
     {
          ...
          var target_input = $('#'+urlobj+'-image-path');
          var target_preview = $('#'+urlobj+'-image-preview');
          ...
          window.SetUrl = function (items) {
              ...
              url = file_path.replace(pathAbsolute+"storage/photos", "");
     ...
     // });
      ...
      $('#service-pick-image').click(function(){
      BrowseServer('service');
      return false;
     });
      $('#album-pick-image').click(function(){
      BrowseServer('album');
      return false;
     });
   ...
   var editor_config = {
     ...
     editor_config.selector = ".service-content";
     // editor_config.path_absolute = "http://php-filemanager.rhcloud.com/examples/basic.html";
     editor_config.path_absolute = window.Blogger.url +"/filemanager";
