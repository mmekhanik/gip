...
<script src="{{url('js/tinymce/tinymce.js')}}"></script>
  <script type="text/javascript">
     ...
     function OpenServerBrowser( url, width, height )
     {
          ...
          var target_input = $('#article-image-path');
          var target_preview = $('#article-image-preview');
          ...
          window.SetUrl = function (items) {
              ...
              url = file_path.replace(pathAbsolute+"storage/images/albums", "");
   ...
   var editor_config = {
     ...
     editor_config.selector = "#album-content";
