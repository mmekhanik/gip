  ...
  <div class="ui segment teal padded">
    ...
    @if(isset($author))
		 <div class="ui divided items">
				<div class="item">
					<div class="ui image">
	                    <a href="{{url('/article/'.$author->display_name)}}">
	                        <img class="ui image avatar-sm" src="{{(!empty($author->avatar))? url('/storage/images/avatars/'.$author->avatar): url('images/avatars/avatar_default.png')}}">
	                    </a>
	                </div><!--end of image-->

	                <div class="middle aligned content">
	                    <div class="header" href="{{url('/article/'.$author->display_name)}}">
				  ...
				  <div class="item">
				    <div class="ui tiny image">
				        <a href="{{url('/article/'.$article->slug)}}">
				          <img class="ui tiny image hoverable" src="{{(!empty($article->article_image))? url(photo_thumbnail($article->article_image,config('blogger.filemanager.upload_path'))): url('images/placeholder_640x480.png')}}">
				        </a>
				    </div>
				    <div class="middle aligned content">
			            <a class="header" href="{{url('/article/'.$article->slug)}}"><h3>{{ $article->title }} </h3></a>
				    ...
				    <div class="middle aligned content right floated">
						<a class="ui right floated tiny primary icon button no-wrap"  href="{{url('/article/'.$article->slug)}}">
