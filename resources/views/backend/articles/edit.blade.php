...
@endif
  ...
  <div class="field fluid hidden {{ $errors->has('slug') ? 'error' : '' }}">
  ...
  <div class="field">
    ...
    <div class="ui segment left floated segment-margin">
      <div id="article-image-preview" class="ui medium bordered image">
        <img  src="{{ (isset($article) && $article->article_image)? url(photo_thumbnail($article->article_image,config('blogger.filemanager.upload_path'))): "" }}" height="5rem">
      </div>
    </div>
  </div>
