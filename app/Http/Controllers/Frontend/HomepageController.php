...
class HomepageController extends Controller
{
    ...
    public function autocomplete()
    {
        ...
        // if (config('blogger.search_engine.enabled')) {
            $articles = $this->articleRepository->search(request('query'));
        // }else{
        //  dd($articles);
    ...
    public function subscriptionConfirm($email = null)
    {
        ...
        // dd($success);
        return view('frontend.subscription_confirmation', compact('success', 'email'));
    ...
    public function about()
    {
        ...
        //     $author->ability('user|administrator|superadministrator');
        //     dd( $author);
        // }
        //$authors = User::whereRoleIs('administrator')->orWhereRoleIs('superadministrator')->get();
        //dd( $authors);
        return view('frontend.aboutus', compact('authors'));
    }
    ...
    public function search()
    {
        ...
        $articles = $this->articleRepository->search($query)->paginate(config('blogger.articles_per_page'));
