					...
					<div class="item">
	                    ...
	                    <div class="ui tiny image">
	                        <a href="{{url('/article/'.$article->slug)}}">
	                          <img class="ui tiny hoverable image" src="{{(!empty($article->article_image))? url(photo_thumbnail($article->article_image,config('blogger.filemanager.upload_path'))): url('images/placeholder_640x480.png')}}">
	                        </a>
	                    </div><!--end of image-->
