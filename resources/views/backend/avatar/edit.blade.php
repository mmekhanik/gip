...
<img class="ui centered middle aligned image avatar-sm" src="{{(!empty(Auth::user()->avatar))? url('/storage/images/avatars/'.Auth::user()->avatar) : url('images/avatars/avatar_default.png') }}">
...
$(document).ready(function() {
  var croppedFile;
    ...
    function resetUpload(){
      $uploadCrop.croppie('bind', {
         url: "{{ (!empty(Auth::user()->avatar))? url('/storage/images/avatars/'.Auth::user()->avatar) : url('images/avatars/avatar_default.png') }}"
      });
