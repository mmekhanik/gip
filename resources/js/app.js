...
const ROOT_DIR = window.Blogger.url || "http://gipirion.local"; 
// const ROOT_DIR ="http://gipirion.local"; 
// console.log('ROOT_DIR in resources/js/app.js ' +ROOT_DIR);
...
var albumOptions = {
  valueNames: [ 
    ...
    'album-table-banner',
    'album-table-title',
    'album-table-photo-count',
    'album-table-created-at',
  ],
  sortClass: "sortable",
  listClass: "listable",
  page: 10,
  item: "album-table-no-results",
  pagination: true,
  // plugins: [
  //   ListPagination(topPaginationOptions),
  //   ListPagination(bottomPaginationOptions)
...
var albumTableList = new List('album-table-list', albumOptions);
...
var photoOptions = {
  valueNames: [ 
    ...
    'photo-table-title',
    'photo-table-album',
    'photo-table-created-at',
  ],
  sortClass: "sortable",
  listClass: "listable",
  page: 5,
  item: "photo-table-no-results",
  pagination: true,
  // plugins: [
  //   ListPagination(topPaginationOptions),
  //   ListPagination(bottomPaginationOptions)
...
var photoTableList = new List('photo-table-list', photoOptions);
